...
namespace SistemaControleVendas.Controllers
{
    public class NivelAcessoesController : Controller
    {
        ...
        public NivelAcessoesController(SistemaControleVendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NivelAcessoID,TipoUsuario")] NivelAcesso nivelAcesso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NivelAcessoID,TipoUsuario")] NivelAcesso nivelAcesso)
        {
